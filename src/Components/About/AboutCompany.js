...
const AboutCompany = () => {
    ...
    return (
        <div className=' aboutcompany w-full my-4  md:px-0 '>
            <div className='w-full'>
                <h1 className='lg:py-20 lg:pl-32 p-4 w-full text-3xl font-bold'><span className='text-yellow-500'>ABOUT</span> COMPANY</h1>
            </div>
            ...
            <div className='flex flex-wrap'>
                ...
                <div className="lg:w-4/12 w-full h-auto mt-4 flex justify-center lg:justify-start lg:mt-0"> {/* Adjust margin for mobile view */}
